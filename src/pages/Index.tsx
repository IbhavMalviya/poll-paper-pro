          ...
          <div className="container mx-auto relative">
            ...
            <div className="flex flex-col md:flex-row items-start gap-6 mb-4">
              ...
              <div className="text-left md:text-right bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <p className="text-white/90 text-sm font-medium mb-1">Annual Carbon Footprint Cost</p>
                <p className="text-3xl md:text-4xl font-bold text-white">₹{(carbonFootprint.total * 3 * 365).toFixed(0)}</p>
